...
namespace CSGOHUD.Controls
{
    public partial class PlayerStatisticsLeft
    {
        ...
        public static readonly DependencyProperty PlayerNumberProperty = DependencyProperty.Register("PlayerNumber", typeof(string), typeof(PlayerStatisticsLeft), new UIPropertyMetadata("1"));
        public static readonly DependencyProperty HealthProperty = DependencyProperty.Register("Health", typeof(string), typeof(PlayerStatisticsLeft), new UIPropertyMetadata("0"));
        ...
        public static readonly DependencyProperty KillsProperty = DependencyProperty.Register("Kills", typeof(string), typeof(PlayerStatisticsLeft), new UIPropertyMetadata("0"));
        public static readonly DependencyProperty MoneyProperty = DependencyProperty.Register("Money", typeof(string), typeof(PlayerStatisticsLeft), new UIPropertyMetadata("0"));
        ...
        public static readonly DependencyProperty HelmetImageSourceProperty = DependencyProperty.Register("HelmetImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty FlashImageSourceProperty = DependencyProperty.Register("FlashImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty SmokeImageSourceProperty = DependencyProperty.Register("SmokeImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty ImpactImageSourceProperty = DependencyProperty.Register("ImpactImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty PlayerImageSourceProperty = DependencyProperty.Register("PlayerImageSource", typeof(string), typeof(PlayerStatisticsLeft), new UIPropertyMetadata("../Images/T.jpg"));
        public static readonly DependencyProperty MainGunProperty = DependencyProperty.Register("MainGunImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty DefuzesImageSourceProperty = DependencyProperty.Register("DefuzesImageSource", typeof(string), typeof(PlayerStatisticsLeft));
        public static readonly DependencyProperty PistolImageSourceProperty = DependencyProperty.Register("PistolImageSource", typeof(string), typeof(PlayerStatisticsLeft));
