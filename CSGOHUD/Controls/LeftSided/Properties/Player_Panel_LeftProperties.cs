...
namespace CSGOHUD.Controls.LeftSided
{
    public partial class Player_Panel_Left
    {
        public static readonly DependencyProperty DeadProperty =
            DependencyProperty.Register("Dead", typeof(bool), typeof(Player_Panel_Left), new UIPropertyMetadata(true));
        public static readonly DependencyProperty HealthProperty =
            DependencyProperty.Register("Health", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        public static readonly DependencyProperty NickNameProperty =
            DependencyProperty.Register("NickName", typeof(string), typeof(Player_Panel_Left), new UIPropertyMetadata(string.Empty));
        public static readonly DependencyProperty KillsProperty =
            DependencyProperty.Register("Kills", typeof(string), typeof(Player_Panel_Left), new UIPropertyMetadata("0"));
        public static readonly DependencyProperty KillsStreakProperty =
            DependencyProperty.Register("KillsStreak", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        public static readonly DependencyProperty DeathsProperty =
            DependencyProperty.Register("Deaths", typeof(string), typeof(Player_Panel_Left), new UIPropertyMetadata("0"));
        public static readonly DependencyProperty MoneyProperty =
            DependencyProperty.Register("Money", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        public static readonly DependencyProperty DefuzerProperty =
            DependencyProperty.Register("Defuzer", typeof(bool), typeof(Player_Panel_Left), new UIPropertyMetadata(false));
        public static readonly DependencyProperty C4Property =
            DependencyProperty.Register("C4", typeof(bool), typeof(Player_Panel_Left), new UIPropertyMetadata(false));
        public static readonly DependencyProperty TeamBrushProperty =
            DependencyProperty.Register("TeamBrush", typeof(Brush), typeof(Player_Panel_Left), new UIPropertyMetadata(Brushes.LightGray));
        public static readonly DependencyProperty TeamColorProperty =
            DependencyProperty.Register("TeamColor", typeof(Color), typeof(Player_Panel_Left), new UIPropertyMetadata(Colors.LightGray));
        public static readonly DependencyProperty ArmorBodyProperty =
            DependencyProperty.Register("ArmorBody", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        public static readonly DependencyProperty FlashedProperty =
            DependencyProperty.Register("Flashed", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        public static readonly DependencyProperty SmokedProperty =
            DependencyProperty.Register("Smoked", typeof(int), typeof(Player_Panel_Left), new UIPropertyMetadata(0));
        ...
        private static readonly DependencyProperty TeamProperty =
            DependencyProperty.Register("Team", typeof(PlayerTeam), typeof(Player_Panel_Left), new UIPropertyMetadata(PlayerTeam.None));
        private static readonly DependencyProperty SelectedProperty =
            DependencyProperty.Register("Selected", typeof(bool), typeof(Player_Panel_Left), new UIPropertyMetadata(false));
        ...
        public PlayerTeam Team
        {
            ...
            set
            {
                ...
                {
                    Panel_Left.Visibility = Visibility.Visible;
                ...
                {
                    Panel_Left.Visibility = Visibility.Collapsed;
